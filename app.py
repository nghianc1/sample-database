...
# 1. Cấu hình giao diện & Logo từ thiết bị
LOCAL_LOGO_PATH = "logo.png"

if os.path.exists(LOCAL_LOGO_PATH):
    img_icon = Image.open(LOCAL_LOGO_PATH)
else:
    img_icon = ""

st.set_page_config(
    page_title="Dữ Liệu Mẫu",
    page_icon=img_icon,
    layout="wide"
)
...
st.write("Ứng dụng chạy trực tuyến - Tự động đồng bộ dữ liệu từ Google Sheets.")
...
try:
    ...
    # ----------------------------------------------------
        ...
        st.header("Tra Cứu & Tìm Kiếm Mẫu")
        ...
        if selected_pathogen == "Tất cả tác nhân":
            st.subheader("Cơ sở dữ liệu mẫu: Gom toàn bộ các tác nhân gây bệnh")
            ...
            st.subheader(f"Cơ sở dữ liệu mẫu: Tác nhân {selected_pathogen}")
        ...
        search_query = st.text_input(
            ...
            placeholder="Ví dụ: 'toxocara dương tính', '7438 pos', 'hpv âm tính'..."
        )
